    ...
    <div class="row mx-xl-5 py-4 footer-container">
        ...
        <div class="col-md-2 mb-4 text-center text-md-left">
            ...
            <ul class="list-unstyled">
                <li><a href="{{ route('privacy-policy') }}" class="text-secondary">Privacy Policy</a></li>
                <li><a href="{{ route('terms_conditions') }}" class="text-secondary">Terms & Conditions</a></li>
            </ul>
        </div>
        ...
        <div class="col-md-2 mb-4 text-center text-md-left">
            ...
            <div>
                <a href="{{ \App\Models\Setting::getValue('customer_facebook') }}" class="text-secondary mx-2" target="_blank">
                    <i class="fab fa-facebook-f"></i>
                </a>
                <a href="{{ \App\Models\Setting::getValue('customer_youtube') }}" class="text-secondary mx-2"><i class="fab fa-twitter"></i></a>
                <a href="{{ \App\Models\Setting::getValue('customer_instagram') }}" class="text-secondary mx-2"><i class="fab fa-instagram"></i></a>
                <a href="{{ \App\Models\Setting::getValue('customer_whatsapp') }}" class="text-secondary mx-2"><i class="fab fa-linkedin"></i></a>
            </div>
        </div>
    ...
    <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
        <div class="col-md-12 px-xl-0 text-center text-md-center">
            <!-- <p class="mb-md-0 text-secondary">
                &copy; {!! \App\Models\Setting::getValue('footer_text') !!}
            </p> -->
            <p class="mb-md-0 text-secondary">
