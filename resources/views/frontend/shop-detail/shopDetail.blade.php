            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                <div class="bg-white shadow-sm rounded p-3 h-100 d-flex flex-column justify-content-between">
                    <div class="text-center">
                        <a href="{{ route('product-detail', ['id' => $relatedProduct->id]) }}" class="product-img-hover">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-2">
                            ...
                            <p class="mb-0" style="font-size: 14px; color: {{ $relatedProduct->stock_status == 'In stock' ? 'green' : 'red' }}">
                    ...
                    <div class="d-flex justify-content-between mt-3">
                        <button class="btn btn-sm btn-outline-primary w-50 mr-1 add-to-cart" data-id="{{ $relatedProduct->id }}">
                            Add To Cart
                        </button>
                        <a href="{{ route('cart.orderNow', $relatedProduct->id) }}" class="btn btn-sm btn-primary w-50 ml-1">
                            Order Now
                        </a>
                    </div>
                </div>
...
<script>
    ...
    $.ajax({
        url: "{{ url('/buy-now') }}/" + productId, // ✅ নতুন Buy Now Route
        method: "POST",
        data: {
            _token: csrfToken,
        },
