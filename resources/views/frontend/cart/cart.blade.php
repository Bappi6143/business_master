                    ...
                    <tbody>
                        ...
                        <tr data-id="{{ $item['id'] }}">
                            ...
                            <td>
                                ...
                                <input type="text" class="form-control d-inline text-center quantity-input" value="{{ $item['quantity'] }}" style="width: 50px;" readonly>
        ...
        <div class="col-lg-4">
            ...
            <div class="bg-light p-30 mb-5">
                ...
                <div class="pt-2">
                    ...
                    <a href="{{ route('checkout') }}" class="btn btn-block btn-primary font-weight-bold my-3 py-3">
                        Proceed To Checkout
                    </a>
                </div>
            </div>
