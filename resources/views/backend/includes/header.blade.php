                            ...
                            <div class="row row-cols-3 g-3 p-3">
                                ...
                                <div class="col text-center">
                                    <div class="app-box mx-auto bg-gradient-kyoto text-dark">
                                        <a href="{{ route('home') }}" target="_blank"><i class="bx bx-notification"></i></a>
                                    </div>
                                    <div class="app-title">Website</div>
                                </div>
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="user-info ps-3">
                        <p class="user-name mb-1">{{ Auth::User()->name }}</p>
                        <p class="designattion mb-0">ID: {{ Auth::user()->tenant->name ?? 'No Tenant' }}</p>
